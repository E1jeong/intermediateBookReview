...
import com.fastcampus.intermediatebookreview.databinding.ItemHistoryBinding
import com.fastcampus.intermediatebookreview.model.History

class HistoryAdapter(val historyDeleteClickedListener: (String) -> Unit): androidx.recyclerview.widget.ListAdapter<History, HistoryAdapter.HistoryItemViewHolder>(diffUtil) {
